...
#pragma warning( disable : 4677 )
		frmAdvanced( Query^ query )
		{
			...
			for( int i = 0; i < int( Armor::ArmorType::NumArmorTypes ); ++i )
			{
				...
				boxes[ i ]->ItemChecked += gcnew ItemCheckedEventHandler( this, &frmAdvanced::CheckBoxClicked );
			}
			...
			lvDecorations->ItemChecked += gcnew ItemCheckedEventHandler( this, &frmAdvanced::CheckBoxClicked );
